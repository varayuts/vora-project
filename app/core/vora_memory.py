...
- รุ่น: MyAGV 2023 PI + Gemma3:27b-it + MiniCPM-v2.6
...
PATTERN_RESPONSES = [
    ...
    # Technology patterns
    (r"(ใช้|รัน).*(โมเดล|model|AI)", "ผมใช้ Gemma3:27b-it สำหรับ LLM และ MiniCPM-v2.6 สำหรับ Computer Vision รันบน NVIDIA A6000 ครับ"),
